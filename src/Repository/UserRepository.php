...
class UserRepository extends ServiceEntityRepository
{
    ...
    public function getCountryRanking(): array
    {
        ...
        $sqlQueries = 'SELECT country.name AS country, country.img_url, country.flag ,SUM(user.score)/COUNT(user.id) AS scores, SUM(user.score) AS scoresNotAverage FROM user INNER JOIN country ON user.id_country = country.id GROUP BY country.name, country.img_url, country.flag ORDER BY scores DESC;';
